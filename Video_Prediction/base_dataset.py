...
class VideoDataset(BaseVideoDataset):
    ...
    def parser(self, serialized_example):
        ...
        state_like_seqs, action_like_seqs =             self.slice_sequences(state_like_seqs, action_like_seqs, self._max_sequence_length)
        return state_like_seqs, action_like_seqs
...
class SequenceExampleVideoDataset(BaseVideoDataset):
    ...
    def parser(self, serialized_example):
        ...
        state_like_seqs, action_like_seqs =             self.slice_sequences(state_like_seqs, action_like_seqs, example_sequence_length)
